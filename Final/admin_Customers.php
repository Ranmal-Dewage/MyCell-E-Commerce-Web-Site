...
<html>
	...
	<body>
		...
		<div style="display: flex;">
			<div id="sidebar" style="margin-top: 51px;">
			...
			<div id="content">
				<?php
					...
					echo '<table style="text-align: center; width: 70%; padding-top: 2%; margin-left:40px" align="center" cellspacing="15" cellpadding="5"><th>Customer No</th><th>Username</th><th>Password</th><th>First Name</th><th>Last Name</th><th>Mobile No</th><th>E-mail</th><th>State</th><th>Address</th><th>Edit</th><th>Delete</th>';
					...
					while($row=mysqli_fetch_array($result)){
						...
						'<tr>
							...
							echo "<a href='admin_cus_edit.php?".$row[1]."'";
							echo '><img src="./Index/edit.png" width="85%" height="10%"></a></td>';

							echo "<td style='width:10%'>";
							echo "<a href='admin_cus_delete.php?".$row[1]."'";
							echo '><img src="./Index/remove.png" width="40%" height="5%"></a></td>
						</tr>';
					}
					echo '</table>';
