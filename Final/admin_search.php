			...
			<div id="content">
				<?php
					...
					if(!$row=mysqli_fetch_array($result)){
						echo "
						<p style='text-align:center'><b>No Result Found For Your Search!!!!! Try Something Else!!!</b></p>";
					}
					else{
						echo
							'<table style="text-align: center; width: 70%; padding-top: 2%;" align="center" cellspacing="10">
								<th>Image</th>
								<th>ID</th>
								<th>Name</th>
								<th>Manufacturer</th>
